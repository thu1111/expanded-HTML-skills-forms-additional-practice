...
function createSticky() {
	...
	var color = colorSelectObj.value;
    var categorySelectObj = document.getElementById("category");
    var index = categorySelectObj.selectedIndex;
    var category = categorySelectObj[index].value;
...
function addStickyToDOM(key, stickyObj) {
	...
	span.innerHTML = stickyObj.value + " <br/> <br/> "+ stickyObj.category + " <br/> <br/> "+ stickyObj.priority;
